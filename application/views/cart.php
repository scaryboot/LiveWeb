					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								...
								<li><a href="#"><i class="fa fa-envelope"></i>otocars@gmail.com</a></li>
							</ul>
						</div>
					</div>
				</div>
					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								...
								<li><a href="<?php echo base_url()."index.php/pesan/tambah_data";?>"><i class="fa fa-shopping-cart"></i> Cart</a></li>
			...
			<div class="row">
				...
				<div class="col-sm-6">
					<div class="total_area">
						<ul>
							<li>Total pembelian <span>Rp 350.000</span></li>
							<li>Discount <span>5%</span></li>
							<li>Total <span>Rp 332.500</span></li>
						</ul>
